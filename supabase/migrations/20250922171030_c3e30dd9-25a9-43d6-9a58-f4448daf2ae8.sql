-- Fix the ambiguous column reference in rpc_upsert_site
...
DECLARE
    ...
    new_geom_point geometry;  -- Renamed to avoid ambiguity
BEGIN
    ...
    IF (payload->>'id') IS NOT NULL THEN
        ...
        UPDATE sites SET
            ...
            fonte = payload->>'fonte',
            geom_point = COALESCE(new_geom_point, sites.geom_point),  -- Fixed ambiguity
    ...
    -- Insert new relationships from arrays (handling both string arrays and object arrays)
