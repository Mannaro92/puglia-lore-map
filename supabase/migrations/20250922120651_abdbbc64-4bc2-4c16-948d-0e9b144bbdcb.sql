...
-- Note: This table is part of PostGIS system and should be readable by all
...
-- This is likely the MVT functions we created earlier, let's recreate them with proper search_path

-- Recreate MVT functions with proper security settings
...
-- Recreate province MVT function with proper security
...
-- Recreate comuni MVT function with proper security
