-- Fix remaining critical security issues (excluding system tables)

-- Enable RLS on all remaining public tables (excluding PostGIS system tables)
...
-- Fix function search path issues for MVT functions
...
-- Fix function search path for province MVT
...
-- Fix function search path for comuni MVT
